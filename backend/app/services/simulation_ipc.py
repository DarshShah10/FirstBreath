...
2. The simulation script polls the command directory, executes commands,
...
@dataclass
class IPCCommand:
    """Represents an IPC command sent from Flask to the simulation process."""
    command_id: str
...
@dataclass
class IPCResponse:
    """Represents an IPC response returned by the simulation process."""
    command_id: str
...
class SimulationIPCClient:
    ...
    def __init__(self, simulation_dir: str):
        ...
        Args:
            simulation_dir: Root directory for simulation data.
        """
    ...
    def send_command(
        ...
        Args:
            ...
            poll_interval: Seconds between response file polls.
    ...
    def send_interview(
        ...
        Args:
            agent_id: ID of the agent to interview.
            prompt: Interview question.
            platform: Target platform (optional).
                - "twitter": Interview Twitter platform only.
                - "reddit": Interview Reddit platform only.
                - None: Interview both platforms in dual-platform simulations;
                        interview the active platform in single-platform simulations.
            timeout: Maximum seconds to wait for a response.
    ...
    def send_batch_interview(
        ...
        Args:
            interviews: List of interview entries, each containing
                        {"agent_id": int, "prompt": str, "platform": str (optional)}.
            platform: Default platform for all interviews (optional; overridden per entry).
                - "twitter": Default to Twitter platform only.
                - "reddit": Default to Reddit platform only.
                - None: Interview both platforms per agent in dual-platform simulations.
            timeout: Maximum seconds to wait for a response.
    ...
    def check_env_alive(self) -> bool:
        ...
        Determined by reading the env_status.json status file.
        """
...
class SimulationIPCServer:
    ...
    Polls the command directory, executes commands, and writes responses.
    """
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        """
        Poll the command directory and return the oldest pending command.
        ...
        # Collect and sort command files by modification time (oldest first)
        command_files = []
    ...
    def send_response(self, response: IPCResponse):
        """
        Write a response file and remove the corresponding command file.

        Args:
            response: The IPC response to send.
        """
