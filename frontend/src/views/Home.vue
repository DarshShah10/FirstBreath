        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg. $5 per regular simulation</div>
            </div>
            <div class="metric-card">
          ...
          <div class="steps-container">
            <div class="steps-header">
               <span class="diamond-icon">◇</span> Workflow Sequences
            </div>
...
// Start simulation - Jump immediately; API calls are handled on the Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump immediately to the Process page (using a special identifier for new projects)
    router.push({
      name: 'Process',
...
/* Project Simulation Steps Description */
.steps-container {
  border: 1px solid var(--border);
  padding: 30px;
  position: relative;
...
/* Entry Animation: Subtle Border Pulse */
