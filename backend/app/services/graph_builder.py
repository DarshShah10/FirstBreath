...
Interface 2: builds a Standalone Graph using the Zep API.
"""
...
class GraphBuilderService:
    ...
    def _build_graph_worker(
        ...
        try:
            ...
            # Step 5: Wait for Zep to finish processing
            self.task_manager.update_task(
                task_id,
                progress=60,
            ...
            # Step 6: Retrieve graph information
            self.task_manager.update_task(
                task_id,
                progress=90,
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This usage is required by the Zep SDK; the warnings originate from dynamic
        # class creation and are safe to ignore.
        warnings.filterwarnings('ignore', category=UserWarning, module='pydantic')

        # Zep reserved attribute names that cannot be used as property names
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # Zep API requires Field with a description — this is mandatory
    ...
    def add_text_batches(
        ...
        """Add text chunks to the graph in batches; returns a list of episode UUIDs."""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _get_graph_info(self, graph_id: str) -> GraphInfo:
        """Retrieve summary information for the graph."""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Retrieve the full graph data, including detailed node and edge information.
        ...
        # Build a node UUID to name map for edge source/target resolution
        node_map = {}
        for node in nodes:
