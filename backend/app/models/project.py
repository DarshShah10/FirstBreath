...
Persists project state on the server side to avoid passing large amounts of data between frontend APIs
"""
...
class Project:
    ...
    # Ontology information (filled after API 1 completes)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph information (filled after API 2 completes)
...
class ProjectManager:
    """Project Manager - handles project persistent storage and retrieval"""
